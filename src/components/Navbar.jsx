  ...
  return (
    <div className='fixed top-0 left-0 w-full bg-opacity-70 backdrop-blur-md z-50'>
        ...
        text-xl items-center px-12 h-20'>
            ...
            <a href="/">
            <img src={sidlogo} alt="logo" className='h-20'/>
            </a>
            ...
            <div onClick={toggleNav} className='cursor-pointer md:hidden z-50 text-gray-200'>
            ...
            className='cursor-pointer fixed left-0 top-0 w-full min-h-screen bg-gray-900 z-40'
            >
                <ul className='font-semibold text-4xl space-y-8 mt-24 text-center'>
                    <li><Link to="skills" onClick={closeNav} smooth={true} offset={50} duration={500}>About</Link></li>
                    <li><Link to="portfolio" onClick={closeNav} smooth={true} offset={50} duration={500}>Project</Link></li>

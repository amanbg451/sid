...
import pdf from "../pdf/Siddhant-Lokare CV.pdf";
import {
  AiOutlineLinkedin,
} from "react-icons/ai";
// import {
    ...
    <div className=" mt-24 max-w-[1200px] mx-auto relative">
      <div className="grid md:grid-cols-2 place-items-center gap-8">
        ...
        >
          ...
          >
            Hii, I AM <br />
            <span className="text-orange-600">SIDDHANT</span>
          </motion.p>
          ...
          >
            ...
            <TypeAnimation
              ...
              speed={50}
              repeat={Infinity}
              className="font-bold text-orange-600 text-2xl md:text-2xl italic- mb-4"
            />
          </motion.p>
          ...
          >
            ...
            <div className="flex gap-6 flex-row text-4xl md:text-4xl text-slate-400 z-20">
              ...
              <motion.a
                ...
                href="https://www.linkedin.com/in/siddhant-lokare-18b634315/"
                target="_blank"
